...
#author: Perry
mathjax: true
description: Learn and study qiskit coding by using flashcards, only at Wrelks.com!
permalink: /qiskit-flashcards-easy
sharing: true
---
  ...
  "cards": [
    {
      ...
      "frontCopy": "How do you create a Quantum Circuit that has 3 Quantum Bits and 3 Classical Bits by using only one line of code?",
      "backMedia": {
        "mimeType": null,
        "src": null
      },
      "backCopy": "<code>qc = QuantumCircuit(3)</code>"
    },
    {
      "position": 2,
      "frontMedia": {
    ...
    },
    {
      ...
      "backCopy": "<code><p>from qiskit import QuantumRegister, ClassicalRegister, QuantumCircuit </p><p> q = QuantumRegister(2) </p><p> c = ClassicalRegister(1)</p></code>"
    },
  ]
};
